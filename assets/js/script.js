...
(function($){
    ...
    if($("#googlemap").length > 0){
        ...
        var marker = new google.maps.Marker({
                ...
                map: map,
                position: new google.maps.LatLng(37.828285, -122.372593)  //change the coordinates

        });

        var infowindow = new google.maps.InfoWindow({

                content: "<div style='color:#222' <b>San Francisco, 94130<b/> </div>"  //change your address
